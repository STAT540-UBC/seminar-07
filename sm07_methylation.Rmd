...
Let's look at differential methylation for a different contrast. For the `act_naive - act_rTreg` contrast:

- Plot the top 5 differentially methylated probes, and add the name(s) of the nearest genes to the plot.
